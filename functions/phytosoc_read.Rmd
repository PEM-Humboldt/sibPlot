...
getMetadataPhytoXl <-
    ...
    # In the future we might need to pass the file and sheet to the function (in order to keep them in the metadata)
  {
    ...
    tabRecoFi<- data.frame(regex= Reduce(c,spec_fito$pf_spec$recoField_pf), nameFi= rep(names(spec_fito$pf_spec$recoField_pf), sapply(spec_fito$pf_spec$recoField_pf,length)))
